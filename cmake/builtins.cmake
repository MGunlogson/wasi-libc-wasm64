...
if(BUILTINS_LIB)
  ...
  ExternalProject_Add(
    wasi-sdk-builtins
    EXCLUDE_FROM_ALL ON
    URL https://github.com/yagehu/wasi-sdk/releases/download/wasi-sdk-29/libclang_rt-29.0.tar.gz
    CONFIGURE_COMMAND ""
    BUILD_COMMAND ""
    INSTALL_COMMAND ""
  )
  ExternalProject_Get_Property(wasi-sdk-builtins SOURCE_DIR)
  # Upstream's refactor (one add_custom_command below, driven by these two
  # variables) with the per-architecture path this branch needs: upstream
